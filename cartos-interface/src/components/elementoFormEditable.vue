            ...
            <v-container>
                  ...
                  <div class="p-container">
                    <div class="child">
                       <v-select class="change-font" v-if="colecao!=='Outra' && (counterCol == 0 || counterCol == 2)"
                        ...
                        <v-text-field v-else :label="$t('p1.col2')" :placeholder="$t('p1.string')" @input="handleInput('col')" v-model="colecao"></v-text-field>
                    </div>
                    <div class="child">
                      <v-text-field
                        :label="$t('p1.num')"
                  ...
                  <div class="p-container">
                    ...
                    <div class="child">
                      <v-select class="change-font" v-if="lingua!=='Outra' && (counterLingua == 0 || counterLingua == 2)"
                        ...
                        <v-text-field v-else :placeholder="$t('p1.string')" :label="$t('p1.lin2')" @input="handleInput('lingua')" v-model="lingua"></v-text-field>
                    </div>
                  </div>
                  <div class="p-container">
                    <div class="child">
              ...
              <div class="p-container">
                <div class="child">
                  ...
                  <v-text-field v-else :label="$t('p1.edi2')" :placeholder="$t('p1.string')" @input="handleInput('editora')" v-model="editora"></v-text-field>                  
                </div>
                <div class="child">
                  <v-text-field
                    :label="$t('p1.dataP')"
              ...
              <div class="p-container">
                ...
                <div class="child">
                  ...
                  <v-text-field v-else :label="$t('p1.tipo2')" :placeholder="$t('p1.string')" @input="handleInput('tipo')" v-model="tipo"></v-text-field>                  
                </div>
              </div>
            </v-container>
