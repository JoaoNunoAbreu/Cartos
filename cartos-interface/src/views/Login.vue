  ...
  <div>
    ...
    <div id="form">
      <v-form ref="form" method="login">
        ...
        <v-container>
          <v-btn depressed width="480px" color="#29b89b" class="white--text" @keydown.enter="postLogin" @click="postLogin">{{$t('login.enter')}}</v-btn>
          <v-btn depressed width="480px" color="#29b89b" outlined class="mt-3" to="/registo">{{$t('login.naotemconta')}}</v-btn>
        </v-container>
      </v-form>
    </div>   
    <v-dialog
